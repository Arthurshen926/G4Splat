...
#define SURFACE_ALPHA_OFFSET 7
#define VOLUME_ALPHA_OFFSET 8
#define SURFACE_DEPTH_OFFSET 9
#define VOLUME_DEPTH_OFFSET 10
#define VOLUME_PREHIT_ALPHA_OFFSET 11
#define VOLUME_HIT_INTERVAL_ALPHA_OFFSET 12
